...
public class MemcachedClient
{
    ...
    // return codes
    private static final String VALUE = "VALUE"; // start
                                                 // of
                                                 // value
                                                 // line
                                                 // from
                                                 // server
    private static final String STATS = "STAT"; // start
                                                // of
                                                // stats
                                                // line
                                                // from
                                                // server
    private static final String ITEM = "ITEM"; // start
                                               // of
                                               // item
                                               // line
                                               // from
                                               // server
    private static final String DELETED = "DELETED"; // successful
                                                     // deletion
    private static final String NOTFOUND = "NOT_FOUND"; // record
                                                        // not
                                                        // found
                                                        // for
                                                        // delete
                                                        // or
                                                        // incr/decr
    private static final String STORED = "STORED"; // successful
                                                   // store
                                                   // of
                                                   // data
    private static final String NOTSTORED = "NOT_STORED"; // data
                                                          // not
                                                          // stored
    ...
    private static final String ERROR = "ERROR"; // invalid
                                                 // command
                                                 // name
                                                 // from
                                                 // client
    private static final String CLIENT_ERROR = "CLIENT_ERROR"; // client
                                                               // error
                                                               // in
                                                               // input
                                                               // line
                                                               ...
                                                               // invalid
                                                               // protocol
    private static final String SERVER_ERROR = "SERVER_ERROR"; // server
                                                               // error
    ...
    private boolean set(String cmdname, String key, Object value, Date expiry, Integer hashCode, boolean asString)
    {
        ...
        if (NativeHandler.isHandled(value))
        {
            ...
            if (asString)
            {
                ...
                {
                    if (log.isInfoEnabled())
                        log.debug("++++ storing data as a string for key: " + key + " for class: "
    ...
    public long getCounter(String key, Integer hashCode)
    {
        ...
        catch (Exception ex)
        {
            ...
            if (log.isInfoEnabled())
                log.debug(String.format("Failed to parse Long value for key: %s", key));
        }
