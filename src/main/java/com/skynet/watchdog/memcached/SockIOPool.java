 ...
 */
package com.skynet.watchdog.memcached;
...
public class SockIOPool
{
	...
	public static final int						NATIVE_HASH		= 0;											// native
																												// String.hashCode();
	public static final int						OLD_COMPAT_HASH	= 1;											// original
																												// compatibility
																												// hashing
																												// algorithm
																												// (works
																												...
																												// other
																												// clients)
	public static final int						NEW_COMPAT_HASH	= 2;											// new
																												// CRC32
																												// based
																												// compatibility
																												// hashing
																												...
																												// other
																												// clients)
	public static final int						CONSISTENT_HASH	= 3;											// MD5
																												// Based
																												// --
																												// Stops
																												// thrashing
	...
	public static final long					MAX_RETRY_DELAY	= 10 * 60 * 1000;								// max
																												// of
																												// 10
																												// minute
																												// delay
	...
	private long								maxIdle			= 1000 * 60 * 5;								// max
																												// idle
																												// time
																												// for
																												// avail
																												// sockets
	private long								maxBusyTime		= 1000 * 30;									// max
																												// idle
																												// time
																												// for
																												// avail
																												// sockets
	private long								maintSleep		= 1000 * 30;									// maintenance
																												// thread
																												// sleep
																												// time
	private int									socketTO		= 1000 * 3;									// default
																												// timeout
																												// of
																												// socket
																												// reads
	private int									socketConnectTO	= 1000 * 3;									// default
																												// timeout
																												// of
																												// socket
																												// connections
	private boolean								aliveCheck		= false;										// default
																												// to
																												// not
																												// check
																												// each
																												...
																												// being
																												// alive
	private boolean								failover		= true;										// default
																												// to
																												// failover
																												// in
																												// event
																												...
																												// server
																												// dead
	private boolean								failback		= true;										// only
																												// used
																												// if
																												// failover
																												// is
																												...
																												// into
																												// rotation
	private boolean								nagle			= false;										// enable/disable
																												// Nagle's
																												// algorithm
	private int									hashingAlg		= NATIVE_HASH;									// default
																												// to
																												// using
																												// the
																												// native
	 ...
	 */
	protected SockIO createSocket(String host) throws Exception
	{
	 ...
	 */
	protected void selfMaint()  throws Exception
	{
	...
	protected static class MaintThread extends Thread
	{
		...
		private long			interval	= 1000 * 3;										// every
																								// 3
																								// seconds
		...
		public void trueClose(boolean addToDeadPool) throws IOException
		{
			...
			if (out != null)
			{
				...
				catch (IOException ioe)
				{
					...
					log.error(ioe.getMessage(), ioe);
					errMsg.append("++++ error closing output stream for socket: " + toString() + " for host: " + getHost() + " maybe output stream is Closed \n");
					errMsg.append(ioe.getMessage());
					err = true;
				}
			}
